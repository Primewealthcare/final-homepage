          ...
          <div className="row g-5">
            <div className="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
              <div className="position-relative rounded about-image-wrapper">
                ...
                />
                <div
                  className="position-absolute top-0 start-0 experience-badge rounded pe-2 pb-2"
                  style={{ width: 140, height: 140 }}
                >
                  <div
                    className="d-flex flex-column justify-content-center text-center  rounded h-100 p-3"
            ...
            <div className="col-lg-6 wow reveal fadeInUp" data-wow-delay="0.2s">
              <div className="h-100">
                ...
                <p className="fs-5 reveal mb-4">
                  ...
                  Insurance Plans that grow with you, ensuring that you’re
                  always protected—no matter where life takes you.
                </p>
                <div className="row g-4 mb-4">
                  <div className="col-sm-6">
                    <div className="d-flex align-items-center">
                      <img className="flex-shrink-1 me-3" src={Policy} />
                      <h5 className="mb-0 reveal">Flexible Insurance Plans</h5>
                    </div>
                  </div>
                  <div className="col-sm-6">
                    <div className="d-flex align-items-center">
                ...
                <p className="mb-4">
                  Your trust is our top priority. We understand the importance
                  of peace of mind when choosing an insurance plan. That's why
                  we offer a Money-Back Guarantee to ensure that you are
      ...
      <div className="container-fluid overflow-hidden my-5 px-lg-0">
        <div className="container facts px-lg-0">
          <div className="row g-0 mx-lg-0">
            <div
              className="col-lg-6 facts-text wow fadeInUp"
              data-wow-delay="0.1s"
            >
